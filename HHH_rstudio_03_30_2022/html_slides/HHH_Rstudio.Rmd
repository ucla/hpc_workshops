...
For more information on using containers, there will be a Workshop [Using
Containers on HPC
...
At this point, RStudio will start to run on the compute node. You will see information about this RStudio session. You will need to take note of **compute node name** and **port number**. KEEP THIS TERMINAL OPEN.
